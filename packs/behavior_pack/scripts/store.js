...
export function registerDynamicProperties(_event) {
  // Compatibility no-op.
  // Some Bedrock API targets available on Realms no longer expose
  // DynamicPropertiesDefinition as an import. We therefore avoid hard
  // registration at startup and instead attempt direct property access.
}
